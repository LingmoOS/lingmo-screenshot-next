...
void Controller::openShotCutWindow()
{
    ...
    if (!m_shortCutWindow) {
        ...
        kdk::LingmoStyleHelper::self()->removeHeader(m_shortCutWindow);
...
//             /2));
//        kdk::LingmoStyleHelper::self()->removeHeader(m_infoWindow);
...
//    }
    ...
    if (!m_aboutdialog) {
        ...
        kdk::LingmoStyleHelper::self()->removeHeader(m_aboutdialog);
        m_aboutdialog->show();
        m_aboutdialog->move(
...
void Controller::openLauncherWindow()
{
    ...
    if (!m_launcherWindow) {
        ...
        kdk::LingmoStyleHelper::self()->removeHeader(m_launcherWindow);
...
void Controller::doLater(int msec, QObject *receiver, lambda func)
{
    ...
    delaywidget->hide();
    kdk::LingmoStyleHelper::self()->removeHeader(delaywidget);
